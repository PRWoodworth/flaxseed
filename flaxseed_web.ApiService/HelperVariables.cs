namespace flaxseed_web.ApiService
{
    public class HelperVariables
    {
        ...
        static readonly Dictionary<char, List<string>> Letter_Colors = new ColorArrays().Init_Letter_Colors_Dict();
        static readonly Dictionary<char, List<string>> Punctuation_Colors = new ColorArrays().Init_Punctuation_Colors_Dict();
        static readonly Dictionary<char, List<string>> Number_Colors = new ColorArrays().Init_Number_Colors_Dict();
