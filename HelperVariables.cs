...
namespace flaxseed
{
    internal static class HelperVariables
    {
        ...
        static readonly Dictionary<char, List<string>> Space_Colors = new Color_Arrays().Init_Space_Colors_Dict();
        ...
        public static Dictionary<char, List<string>> Space_Colors_Public => Space_Colors;
